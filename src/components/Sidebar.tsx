...
const NAV_ITEMS = [
  { id: 'dashboard', label: '控制台 首页', icon: LayoutDashboard },
  { id: 'proxies', label: '节点与代理', icon: Globe2 },
  { id: 'profiles', label: '订阅与配置', icon: FolderGit2 },
  { id: 'rules', label: '路由规则', icon: Route },
  { id: 'logs', label: '实时日志', icon: Terminal },
  { id: 'json-config', label: '高级 JSON 编辑', icon: FileCode2 },
...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 h-screen glass-nav flex flex-col justify-between p-4 z-20">
      <div>
        {/* Logo & Title */}
        <div className="flex items-center gap-3 px-3 py-4 border-b border-white/10 mb-4">
          ...
          <div>
            ...
            <p className="text-xs text-blue-400 font-medium">Xray-core Next GUI</p>
          </div>
        </div>
        ...
        <div className="px-3 mb-4">
          <div className="flex items-center justify-between p-2.5 rounded-lg bg-slate-900/60 border border-white/5 text-xs">
            ...
            <span className="text-slate-500 text-[10px]">v1.8.24</span>
          </div>
        </div>
