  ...
  return (
    <span ref={wrapRef} className={`inline-flex items-center gap-1 relative ${className}`}>
      ...
      <button
        ...
        className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full text-slate-500 hover:text-blue-400 hover:bg-blue-500/10 transition-colors shrink-0 cursor-pointer"
        title="字段说明"
      >
