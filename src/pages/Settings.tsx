      ...
      <div className="glass-card p-6 rounded-2xl space-y-5 border border-white/10 bg-slate-900/40">
        <div className="flex items-center justify-between border-b border-white/10 pb-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base font-bold text-white">Xray 内核管理与版本切换 (Kernel Engine)</h3>
          </div>
        ...
        <div className="space-y-2">
          <label className="block text-xs font-semibold text-slate-300">选择已安装的内核 (Installed Kernels)</label>
